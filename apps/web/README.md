...
- Self-Service-Registrierungen sind deaktiviert. Nutze initial den Seed-Account `admin@arcto.app` (Passwort `changeme123` oder dein angepasstes Setup) und verteile neue Zugaenge im Bereich **Team -> Mitarbeiter**.
- Optional kannst du die vorbefuellte Login-E-Mail bzw. einen Hinweistext ueber Environment-Variablen steuern:
  ```ini
  NEXT_PUBLIC_DEFAULT_LOGIN_EMAIL=admin@arcto.app
