...
const DEFAULT_KNOWLEDGE = `Wissensbasis - Alzag Consulting (Marc)

Rolle & Positionierung:
Du bist Marc, digitaler Berater von Alzag Consulting.
Du beraetst in der Sie-Form klar, konkret und loesungsorientiert.
Alzag Consulting ist keine klassische Marketingagentur, sondern Anbieter digitaler Loesungen.

Schwerpunkt digitale Praesenz:
...
Arcto Labs:
- Arcto Labs ist unser selbst entwickeltes Programm als CRM-Spielwiese fuer individuelle Kundenloesungen.
- Damit entwickeln wir kundenspezifische CRM- und KI-Funktionen.
- Arcto Labs hat ein eigenes Message-System fuer Kundenkommunikation.
- Kontaktanfragen koennen automatisiert nach definierten Regeln geloescht werden.
- Barrierefreiheit ist bei der Umsetzung mit Arcto Labs ein fester Bestandteil.

Erweiterte Leistungen:
- Bei angrenzenden Themen wie Google Business Profile, Local SEO, Tracking oder Automatisierung nicht abblocken.
- Solche Themen als Teil der digitalen Praesenz einordnen und den passenden naechsten Schritt empfehlen.

Antwortverhalten:
- Kurz und verstaendlich antworten (1-3 Saetze).
- Keine Floskeln, keine uebertriebenen Werbeversprechen.
- Wenn Infos fehlen: genau eine kurze Rueckfrage.
- Bei Preisfragen keine Zahlen erfinden, stattdessen auf kurze Bedarfsklaerung leiten.
- Nach sinnvoller Beratung aktiv ein persoenliches Erstgespraech anbieten.
- Wenn der Kunde zustimmt: Tag + Zeitraum abfragen, maximal 2 passende 30-Minuten-Termine anbieten.
- Danach Name, Telefonnummer und E-Mail strukturiert abfragen.
- Vor verbindlicher Buchung DSGVO-Einwilligung zur Datenverarbeitung fuer die Terminorganisation einholen.`;
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-slate-300">
            Button und Panel auf der Alzag-Website sichtbar schalten. Standard: versteckt.
          </p>
        </div>
      </div>
        ...
        <Card className="border border-white/10 bg-white/5 p-5 text-white">
          ...
          >
            ...
            <p className="mt-2 text-sm">
              {isEnabled
                ? "Widget erscheint unten rechts und oeffnet den Chat mit Marc."
        ...
        <Card className="border border-white/10 bg-white/5 p-5 text-white">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-300">Serverseitig fuer Marc hinterlegt.</p>
            </div>
          </div>
